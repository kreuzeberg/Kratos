...
ELSE (TRILINOS_LIBRARY_DIR OR TRILINOS_INCLUDE_DIR OR TRILINOS_ROOT)
    ...
    IF (Trilinos_FOUND)
        ...
        # TODO: Activate when TPetra is supported and defaulted
        # LIST(FIND Trilinos_PACKAGE_LIST Tpetra package_index)
        # IF (${package_index} EQUAL -1)
        #     MESSAGE(FATAL_ERROR "Tpetra package is required by TrilinosApplication")
        # ENDIF (${package_index} EQUAL -1)
...
FIND_LIBRARY(TPETRA_CORE_LIBRARY    "${TRILINOS_LIBRARY_PREFIX}tpetra"           ${TRILINOS_LIB_SEARCH_PATH}  NO_DEFAULT_PATH)
#FIND_LIBRARY(TPETRA_KERNELS_LIBRARY "${TRILINOS_LIBRARY_PREFIX}tpetra_kernels"   ${TRILINOS_LIB_SEARCH_PATH}  NO_DEFAULT_PATH)
...
MESSAGE(STATUS "TPETRA_CORE_LIBRARY: " ${TPETRA_CORE_LIBRARY})
#MESSAGE(STATUS "TPETRA_KERNELS_LIBRARY: " ${TPETRA_KERNELS_LIBRARY})
IF(TPETRA_INCLUDE_PATH AND TPETRA_CORE_LIBRARY)
    SET(TRILINOS_INCLUDE_DIR ${TRILINOS_INCLUDE_DIR} ${TPETRA_INCLUDE_PATH})
    SET(TRILINOS_LIBRARIES ${TRILINOS_LIBRARIES} ${TPETRA_CORE_LIBRARY})
    SET(HAVE_TPETRA YES)
    ADD_DEFINITIONS( -DTRILINOS_TPETRA_AVAILABLE)
    find_package_handle_standard_args(TPETRA DEFAULT_MSG TPETRA_CORE_LIBRARY)
ENDIF(TPETRA_INCLUDE_PATH AND TPETRA_CORE_LIBRARY)
