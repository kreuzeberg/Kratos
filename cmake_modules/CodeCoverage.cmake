...
# COVERAGE_TARGET_NAME <TARGET> - For executables ONLY, changes the outgoing target name so instead of `ccov-${TARGET_NAME}` it becomes `ccov-${COVERAGE_TARGET_NAME}`.
...
# WORKING_DIRECTORY <DIRECTORY> - For executables ONLY, sets the working directory from which the executable is ran.
# ~~~
function(target_code_coverage TARGET_NAME)
  # Argument parsing
  set(options AUTO ALL EXTERNAL PUBLIC INTERFACE PLAIN)
  set(single_value_keywords COVERAGE_TARGET_NAME WORKING_DIRECTORY)
  ...
  if(CODE_COVERAGE)
    ...
    if(target_type STREQUAL "EXECUTABLE")
      if(CMAKE_C_COMPILER_ID MATCHES "(Apple)?[Cc]lang"
        ...
        # Print out details of the coverage information to the command line
        add_custom_target(
          ccov-sonarqube-${target_code_coverage_COVERAGE_TARGET_NAME}
          COMMAND
            ${LLVM_COV_PATH} show $<TARGET_FILE:${TARGET_NAME}>
            -instr-profile=${target_code_coverage_COVERAGE_TARGET_NAME}.profdata
            -show-line-counts-or-regions ${LINKED_OBJECTS} ${EXCLUDE_REGEX}
